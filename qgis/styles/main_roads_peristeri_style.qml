...
<qgis autoRefreshTime="0" simplifyDrawingHints="1" simplifyAlgorithm="0" maxScale="0" autoRefreshMode="Disabled" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" readOnly="0" labelsEnabled="0" simplifyLocal="1" simplifyMaxScale="1" minScale="100000000" version="3.40.13-Bratislava" simplifyDrawingTol="1">
  ...
  <elevation symbology="Line" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" type="IndividualFeatures" respectLayerSymbol="1" zoffset="0" clamping="Terrain" extrusion="0" zscale="1" binding="Centroid">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" force_rhr="0" type="line" alpha="1" name="" clip_to_extent="1" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{4c3aa55c-7059-4a18-ac9d-8fb22791d22e}" class="SimpleLine" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" force_rhr="0" type="fill" alpha="1" name="" clip_to_extent="1" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{140d3d50-ceee-4489-9291-8ca018a16222}" class="SimpleFill" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" force_rhr="0" type="marker" alpha="1" name="" clip_to_extent="1" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{5e9fe4fb-97e6-4dc6-8d1d-4fbb1f160789}" class="SimpleMarker" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="singleSymbol" forceraster="0">
    <symbols>
      <symbol frame_rate="10" force_rhr="0" type="line" alpha="1" name="0" clip_to_extent="1" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" id="{46ce035b-dd38-45bf-9010-1b12edfc6b9f}" class="SimpleLine" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,0,0,255,hsv:0.99550000000000005,0.60656137941557942,0,1" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" force_rhr="0" type="line" alpha="1" name="" clip_to_extent="1" is_animated="0">
        ...
        <layer enabled="1" pass="0" id="{680c6067-9604-4588-ac1f-c249ebceb699}" class="SimpleLine" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="ref">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="3" field="fclass" name=""/>
    <alias index="4" field="name" name=""/>
    <alias index="5" field="ref" name=""/>
    <alias index="6" field="oneway" name=""/>
    <alias index="7" field="maxspeed" name=""/>
    <alias index="8" field="layer" name=""/>
    <alias index="9" field="bridge" name=""/>
    <alias index="10" field="tunnel" name=""/>
  </aliases>
  <splitPolicies>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="fclass" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="name" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="ref" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="oneway" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="maxspeed" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="layer" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="bridge" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="tunnel" constraints="0" exp_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="fclass"/>
      <column width="-1" type="field" hidden="0" name="name"/>
      <column width="-1" type="field" hidden="0" name="ref"/>
      <column width="-1" type="field" hidden="0" name="oneway"/>
      <column width="-1" type="field" hidden="0" name="maxspeed"/>
      <column width="-1" type="field" hidden="0" name="layer"/>
      <column width="-1" type="field" hidden="0" name="bridge"/>
      <column width="-1" type="field" hidden="0" name="tunnel"/>
